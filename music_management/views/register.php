...
<title>Register &mdash; MUsic Management</title>
...
<div class="auth-shell">
    <div class="auth-side">
        ...
        <h1>Join as a Artist</h1>
        <p>Create your account to start managing music in the music system.</p>
        <ul class="feature-list">
            <li>&#10003; Add and edit musics</li>
    ...
    <div class="auth-form-wrap">
        <div class="auth-card">
            ...
            <p class="muted">Register as a artist</p>
