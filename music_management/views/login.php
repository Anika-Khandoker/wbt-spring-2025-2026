...
<title>Login &mdash; MUsic Management</title>
...
<div class="auth-shell">
    <div class="auth-side">
        ...
        <p>Manage Artists and musics in one place. Sign in to access your dashboard.</p>
        <ul class="feature-list">
            <li>&#10003; Admin manages artists</li>
            <li>&#10003; Artists manage musics</li>
    ...
    <div class="auth-form-wrap">
        <div class="auth-card">
            ...
            <p class="auth-foot">Don't have an account?
                <a href="index.php?page=register">Register as Artist</a>
            </p>
